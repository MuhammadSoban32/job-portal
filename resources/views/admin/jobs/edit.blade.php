                                ...
                                <div class="card-body card-form p-4">
                                    ...
                                    <div class="row">
                                        <div class="form-check mb-4 col-md-6">
                                            <input class="form-check-input" {{ ($job->isFeatured == 1) ? "checked" : "" }}  type="checkbox" value="1" id="isFeatured" name="isFeatured">
                                        ...
                                        <div class="mb-4 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" {{ ($job->status == 1) ? "checked" : "" }} type="radio" value="1" id="status-active" name="status">
                                                <label class="form-check-label" for="status-active">
                                                  Active
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" {{ ($job->status == 0) ? "checked" : "" }}  type="radio" value="0" id="status-block" name="status">
